...
struct ac_compiler_info {
   ...
   /* Flags */
   bool has_lds_bank_count_16;
   bool has_sram_ecc_enabled;
   /* Whether image_sample* instructions can be either a sampler or no-sampler access.*/
   bool has_point_sample_accel;
   bool has_fast_fma32;
   ...
   bool local_invocation_ids_packed;
   ...
   bool has_primid_instancing_bug;
};
