...
public:
   ...
   Result pseudo(aco_opcode opcode, Definition def0)
   {
      ...
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::PSEUDO), num_ops, 1);
            ...
            instr->definitions[0].setNoContract(is_no_contract);
            instr->definitions[0].setNoReassoc(is_no_reassoc);
   ...
   Result pseudo(aco_opcode opcode, Definition def0, Definition def1)
   {
      ...
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::PSEUDO), num_ops, 2);
            ...
            instr->definitions[1].setNoContract(is_no_contract);
            instr->definitions[1].setNoReassoc(is_no_reassoc);
   ...
   Result pseudo(aco_opcode opcode, Definition def0, Definition def1, Definition def2)
   {
      ...
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::PSEUDO), num_ops, 3);
            ...
            instr->definitions[2].setNoContract(is_no_contract);
            instr->definitions[2].setNoReassoc(is_no_reassoc);
   ...
   Result pseudo(aco_opcode opcode, Definition def0, Definition def1, Definition def2, Definition def3)
   {
      ...
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::PSEUDO), num_ops, 4);
            ...
            instr->definitions[3].setNoContract(is_no_contract);
            instr->definitions[3].setNoReassoc(is_no_reassoc);
   ...
   Result pseudo(aco_opcode opcode, Definition def0, Definition def1, Definition def2, Definition def3, Definition def4, Definition def5, Definition def6, Definition def7, Op op0)
   {
      ...
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::PSEUDO), num_ops, 8);
            ...
            instr->definitions[4].setNoContract(is_no_contract);
            instr->definitions[4].setNoReassoc(is_no_reassoc);
            ...
            instr->definitions[5].setNoContract(is_no_contract);
            instr->definitions[5].setNoReassoc(is_no_reassoc);
            ...
            instr->definitions[6].setNoContract(is_no_contract);
            instr->definitions[6].setNoReassoc(is_no_reassoc);
            ...
            instr->definitions[7].setNoContract(is_no_contract);
            instr->definitions[7].setNoReassoc(is_no_reassoc);
   ...
   Result sop1(aco_opcode opcode, Definition def0, Op op0, Op op1)
   {
      unsigned num_ops = 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::SOP1), num_ops, 1);
            instr->definitions[0] = def0;
   ...
   inline Result sop1(WaveSpecificOpcode opcode, Definition def0, Op op0, Op op1)
   {
       return sop1(w64or32(opcode), def0, op0, op1);
   }
   ...
   Result smem(aco_opcode opcode, Op op0, Op op1, Op op2, Op op3, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}})
   {
      unsigned num_ops = 4;
   ...
   Result smem(aco_opcode opcode, Op op0, Op op1, Op op2, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}})
   {
      unsigned num_ops = 3;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::SMEM), num_ops, 0);
            instr->operands[0] = op0.op;
   ...
   Result smem(aco_opcode opcode, Definition def0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}})
   {
      unsigned num_ops = 0;
   ...
   Result smem(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}})
   {
      unsigned num_ops = 3;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::SMEM), num_ops, 1);
            instr->definitions[0] = def0;
   ...
   Result smem(aco_opcode opcode, Definition def0, Op op0, Op op1, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}})
   {
      unsigned num_ops = 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::SMEM), num_ops, 1);
            instr->definitions[0] = def0;
   ...
   Result smem(aco_opcode opcode, Definition def0, Op op0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}})
   {
      unsigned num_ops = 1;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::SMEM), num_ops, 1);
            instr->definitions[0] = def0;
   ...
   Result smem(aco_opcode opcode, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}})
   {
      unsigned num_ops = 0;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::SMEM), num_ops, 0);
   ...
   Result mubuf(aco_opcode opcode, Op op0, Op op1, Op op2, Op op3, unsigned offset, bool offen, bool idxen=false, bool addr64=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lds=false)
   {
      unsigned num_ops = 4;
   ...
   Result mubuf(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, unsigned offset, bool offen, bool idxen=false, bool addr64=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lds=false)
   {
      unsigned num_ops = 3;
      num_ops += disable_wqm * 2;
   ...
   Result mubuf(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, Op op3, unsigned offset, bool offen, bool idxen=false, bool addr64=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lds=false)
   {
      unsigned num_ops = 4;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MUBUF), num_ops, 1);
   ...
   Result mtbuf(aco_opcode opcode, Op op0, Op op1, Op op2, Op op3, unsigned dfmt, unsigned nfmt, unsigned offset, bool offen, bool idxen=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false)
   {
      unsigned num_ops = 4;
      num_ops += disable_wqm * 2;
   ...
   Result mtbuf(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, unsigned dfmt, unsigned nfmt, unsigned offset, bool offen, bool idxen=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false)
   {
      unsigned num_ops = 3;
      num_ops += disable_wqm * 2;
   ...
   Result mimg(aco_opcode opcode, Op op0, Op op1, Op op2, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 3;
      num_ops += disable_wqm * 2;
   ...
   Result mimg(aco_opcode opcode, Op op0, Op op1, Op op2, Op op3, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 4;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 0);
   ...
   Result mimg(aco_opcode opcode, Op op0, Op op1, Op op2, Op op3, Op op4, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 5;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 0);
   ...
   Result mimg(aco_opcode opcode, Op op0, Op op1, Op op2, Op op3, Op op4, Op op5, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 6;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 0);
   ...
   Result mimg(aco_opcode opcode, Op op0, Op op1, Op op2, Op op3, Op op4, Op op5, Op op6, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 7;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 0);
   ...
   Result mimg(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 3;
      num_ops += disable_wqm * 2;
   ...
   Result mimg(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, Op op3, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 4;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 1);
   ...
   Result mimg(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, Op op3, Op op4, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 5;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 1);
   ...
   Result mimg(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, Op op3, Op op4, Op op5, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 6;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 1);
   ...
   Result mimg(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, Op op3, Op op4, Op op5, Op op6, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 7;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 1);
   ...
   Result mimg(aco_opcode opcode, Definition def0, Definition def1, Definition def2, Op op0, Op op1, Op op2, Op op3, Op op4, Op op5, Op op6, Op op7, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 8;
      num_ops += disable_wqm * 2;
   ...
   Result mimg(aco_opcode opcode, Definition def0, Definition def1, Definition def2, Op op0, Op op1, Op op2, Op op3, Op op4, Op op5, Op op6, Op op7, Op op8, Op op9, Op op10, Op op11, Op op12, Op op13, unsigned dmask=0xF, bool da=false, bool unrm=false, bool disable_wqm=false, ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool tfe=false, bool lwe=false, bool r128=false, bool a16=false, bool d16=false)
   {
      unsigned num_ops = 14;
      num_ops += disable_wqm * 2;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::MIMG), num_ops, 3);
   ...
   Result flat(aco_opcode opcode, Op op0, Op op1, Op op2, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 3;
   ...
   Result flat(aco_opcode opcode, Definition def0, Op op0, Op op1, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 2;
   ...
   Result flat(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 3;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::FLAT), num_ops, 1);
            instr->definitions[0] = def0;
   ...
   Result global(aco_opcode opcode, Op op0, Op op1, Op op2, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 3;
   ...
   Result global(aco_opcode opcode, Definition def0, Op op0, Op op1, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 2;
   ...
   Result global(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 3;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::GLOBAL), num_ops, 1);
            instr->definitions[0] = def0;
   ...
   Result scratch(aco_opcode opcode, Op op0, Op op1, Op op2, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 3;
   ...
   Result scratch(aco_opcode opcode, Definition def0, Op op0, Op op1, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 2;
   ...
   Result scratch(aco_opcode opcode, Definition def0, Op op0, Op op1, Op op2, int32_t offset=0, memory_sync_info sync=memory_sync_info(), ac_hw_cache_flags cache={{0, 0, 0, 0}}, bool lds=false, bool nv=false)
   {
      unsigned num_ops = 3;
      Instruction* instr = create_instruction(opcode, (Format)((int)Format::SCRATCH), num_ops, 1);
            instr->definitions[0] = def0;
